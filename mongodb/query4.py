...
for i in range(num_experiments):
    ...
    {"$unwind": "$connections"},  # Add this stage to unwind the 'connections' array
    {"$match": {"connections": {"$exists": True}}},  # Modify the $match stage
], allowDiskUse=True)
...
query_name = '250k_Query4'  # Replace with the name of your query
